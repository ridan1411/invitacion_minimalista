...
<body>
    ...
    <div class="container">
                                        ...
                                        <div class="event-wrap animate-box" style="padding: 25px; background-color: #ffffffc7 !important;">
                                            ...
                                            <div>
                                                <strong>
                                                    <span><i style="color: #4c6199;" class="fas fa-map fa-3x"></i></span>
                                                    <button class="btn btn-sm btn-primary" style="background: white; border-color: white; height: 40px;">
                                                        <p style="margin-bottom: 0px;"><a style="color: black;" target="_blank" href="https://maps.app.goo.gl/wUsga5ux3KA8ZmDu5">Google Maps</a></p>
                                                    </button>
                                                </strong>
                                            </div>
                                        </div>
        ...
        <!-- Dress Code -->
            <div id="fh5co-services" class="fh5co-section-gray" style="background-color: white;">
                <div id="codigovestimenta" class="container animate-box">
                        ...
                        <div class="animate-box text-center fadeInUp animated-fast">
                            <div class="col-md-12">
                                <div class="secondary-font">
                                    ...
                                    <p>Hombres: traje claro u oscuro con o sin corbata o pantalon y camisa de vestir</p>
                                </div>
                                <br>
                                <div class="secondary-font">
                                    <span class="secondary-font">Queremos que luzcan increíbles, pero sin complicaciones.
