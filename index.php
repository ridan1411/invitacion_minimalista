...
<head>
    ...
    <title>Mi Boda | Diana y Alejandro</title>
...
<body>
                    ...
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <div class="display-t">
                            <div class="display-tc animate-box " data-animate-effect="fadeIn">
                                <h1>DIANA<br> &amp; <br> ALEJANDRO</h1>
                                <h2><strong> 07 Feb, 2026 </strong></h2>
    ...
    <div class="texto-titulo mt-1" style="padding: 10px;">
        <p>"Hoy estamos construyendo una nueva historia llena de sueños, cariño y esperanza, y nos emociona invitarte a compartir con nosotros este capítulo tan importante.
            Nos alegrará mucho contar con tu compañía para celebrar el amor, la unión y el comienzo de un camino que deseamos recorrer juntos."</p>
    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6 col-sm-6 text-center">
                                <div class="event-wrap animate-box" style="padding: 25px;">
                                    ...
                                    <div>
                                        <p style="color:black;  margin-bottom: 0px;">Terraza Bacana, Mazamitla, Jal.</p>
                                        <p style="color:black;">Loma Blanca, fraccionamiento las Azaleas, Mazamitla, Jal.</p>
                                    </div>
                                    <div>
                                        <strong>
                                            <p style="margin-bottom: 0px;"><a style="color: #9fba68;;" target="_blank" href="https://maps.app.goo.gl/rb6KQnZmgDCFoMY6A">Google Maps</a></p>
                                        </strong>
                                    </div>
                                    <!-- <div>
                                        <strong>
            ...
            <div class="row animate-box card-wrap" style="margin-left: 5px; margin-right: 5px;">
                <div class="card mb-2 me-1">
                    <div class="text-center">
                        <div class="card-body">
                            <h4 class="card-title"> Claudia Elena Rivera Rivera </h4>
                        </div>
                    </div>
                </div>
                <div class="card mb-2 ms-1">
                    <div class="text-center">
                        <div class="card-body">
                            <h4 class="card-title"> Rafael Garcia Vazquez </h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mb-3">
            ...
            <div class="row animate-box card-wrap" style="margin-left: 5px; margin-right: 5px;">
                <div class="card mb-3 me-1">
                    <div class="text-center">
                        <div class="card-body">
                            <h4 class="card-title"> Blanca Lucia Ramirez Nava </h4>
                        </div>
                    </div>
                </div>
                <div class="card mb-3 ms-1">
                    <div class="text-center">
                        <div class="card-body">
                            <h4 class="card-title"> Alejandro Mora Ceja </h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="animate-box text-center">
                    <div class="col-md-12">
                        <div>
                            <h4>Look Elegante</h4>
                            <p>"Nos encantaría que compartieras este momento con un toque de elegancia. Y para que te sientas cómodo durante la noche, quizá una chaqueta sea buena compañía."</p>
                        </div>
                    </div>
                </div>
                <!-- <div class="animate-box text-center">
        ...
        <div id="asistencia" class="container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                    ...
                    <p><strong>
                            <h6 style="color:white;">¿Nos acompañas? Confirma tu asistencia.</h6>
                        </strong></p>
                </div>
            </div>
