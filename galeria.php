...
<body>
    ...
    <div id="page">
        ...
        <section class="titulo mb-1">
            <div class="texto-titulo mt-1 mb-3">
                ...
                <div class="col-md-12">
                    <ul id="fh5co-gallery-list">
                        ...
                        <li class="one-third animate-box" data-animate-effect="fadeIn"
                            style="background-image: url(images/itzayana-aldo/<?php echo $i?>.jpeg); ">
                        ...
                        <div class="modal fade" id="myModal<?php echo $i ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                ...
                                <img src="images/itzayana-aldo/<?php echo $i ?>.jpeg" width="100%" alt="">
                                </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- <div id="fh5co-counter" class="fh5co-bg fh5co-counter" style="background-image:url(images/img_bg_5.jpg);">
		<div class="overlay"></div>
>>>>>>> da841ec0f0a5de297972100d814bf57e970ec990
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-lg-9 col-xs-2 text-right menu-1">
					<ul>
